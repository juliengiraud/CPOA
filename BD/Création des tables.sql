...
ALTER TABLE Jure
    DROP FOREIGN KEY FK_JURE_PERSONNE;

ALTER TABLE Jure
    DROP FOREIGN KEY FK_JURE_JURY;
...
ALTER TABLE Realise
    DROP FOREIGN KEY FK_REALISE_PERSONNE;

ALTER TABLE Realise
    DROP FOREIGN KEY FK_REALISE_FILM;
...
DROP TABLE Categorie, Film, Jure, Jury, Personne, Photo, Projection, Realise, Salle, User, VIP;